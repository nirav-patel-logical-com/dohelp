        ...
        <!-- Counter Up  -->
        <script src="{{env('APP_URL')}}public/plugins/waypoints/lib/jquery.waypoints.min.js"></script>
        <script src="{{env('APP_URL')}}public/plugins/counterup/jquery.counterup.js"></script>
